...
- a reusable Qt/C++ LLM core
- a set of practical host tools and utility apps
- a growing business-agent reference area

This structure keeps infrastructure, practical tools, and Agent products clearly separated while still allowing them to share the same LLM, Tools, MCP, SKILL, and observability base.
